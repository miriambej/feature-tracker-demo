(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      #${MODAL_ID} .bulk-head, #${MODAL_ID} .bulk-actions { display:flex; align-items:center; justify-content:space-between; gap:12px; }
      ...
      @media (max-width: 720px) { #${MODAL_ID} .bulk-row { grid-template-columns:28px minmax(0,1fr) auto; } #${MODAL_ID} .bulk-warning, #${MODAL_ID} .bulk-ok { grid-column:2/4; } }
    `;
  ...
  function sync() {
    ...
    setTimeout(() => {
      ...
      document.getElementById('bulk-prioritised-backlog')?.remove();
    }, 40);
  }

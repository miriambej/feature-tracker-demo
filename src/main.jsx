...
function DeliveryPlan({ features, allocations, setAllocations, capacities, setCapacities, owners }) {
  ...
  function updateAllocation(allocationId,patch){setAllocations(prev=>prev.map(a=>a.id===allocationId?{...a,...patch}:a));}
